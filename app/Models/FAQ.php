...
class FAQ {
	public static array $FAQList = [
		...
		[
			...
			'answer' => 'After logging in, go to your profile page by clicking your username. Here, you can edit your personal details and save the changes.',
			'tags' => [
				'account'
			],
		],
